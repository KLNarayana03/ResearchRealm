...
<div id="main_part" style="width: 95%">
<div class="main" id="main" style=" display: flex; justify-content: center;align-items: center">
...
<button class="topbutton"><i class="fa-solid fa-message-bot fa-bounce" style="font-size:20px; margin-right:10px;"></i>ChatBot</button>
<hr class="new1">
    </div>
			<br />
			<div class="row">
